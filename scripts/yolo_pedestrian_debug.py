...
class YoloDebugNode:
    def __init__(self):
        ...
        # CONFIGURATION
        # Path to the YOLOv5 repo (cloned folder)
        ...
        try:
            ...
            self.model.classes = [0] # Only detect 'Pedestrian' class
    ...
    def image_callback(self, msg):
        try:
            ...
            # Get the annotated image back (it stays in RGB, so convert back to BGR for ROS)
